...
exports.default = _app2.default; //import App from './components/app.jsx';
...
var _InfoList = __webpack_require__(69);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    // console.log(this.state.restaurant, 'this is the state of the resturant app')
  ...
  _createClass(App, [{
    ...
    value: function render() {
      console.log(this.props, 'im full of no props');
      if (!this.props) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_InfoList.InfoList, { restaurant: this.props }),
        _react2.default.createElement(_MapContainer2.default, { geometry: this.props.geometry })
      );
    }
  }]);
...
var _OpeningHours = __webpack_require__(70);
...
var InfoList = function InfoList(props) {
  var info = {
    ...
    website: {
      ...
      link: { url: props.website, newTab: true }
    },
    directions: {
      text: 'Get Directions',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { className: 'sidebar-expand-arrow'
              // style={ this.state.showPeriods ? { transform: 'rotate(180deg)' } : { transform: 'rotate(0deg)' }}
            },
        ...
        _react2.default.createElement(
          ...
          { className: 'sidebar-flexbox-col sidebar-periods'
            // style={ this.state.showPeriods ? {display: 'flex'} : {'display': 'none'}}
          },
          _react2.default.createElement(Periods, { weekdayText: this.props.info.data.weekdayText })
        )
      );
    }
  }]);
...
var MapContainer = exports.MapContainer = function MapContainer(props) {
  return _react2.default.createElement("div", { className: "sidebar-map-container" });
};
